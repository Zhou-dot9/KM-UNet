...
import torch
from KM_UNetV3_SH import KM_UNetV3
...
def main():
    ...
    # 模型实例化
    model = KM_UNetV3(num_classes=20).cuda()

    model_path = r'/home/ubuntu/zj/KM-UNetV3/outputs/best_model/model_Best_shanghai_DAGEM_DySample_0.55_4.pth'
    ...
    print("=============================Test=================================")
    # 最终测试 - 使用新的可视化方法
    model_path = r'/home/ubuntu/zj/KM-UNetV3/outputs/best_model/model_Best_shanghai_DAGEM_DySample_0.55.pth'
    model.load_state_dict(torch.load(model_path))

    # 使用新的可视化保存路径
    vis_save_path = "/home/ubuntu/zj/KM-UNetV3/outputs/new_visualization"
