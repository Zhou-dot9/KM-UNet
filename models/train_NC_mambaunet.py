...
def test(model, test_loader,criterion):
    ...
    save_dir = "/home/ubuntu/zj/KM-UNetV3/outputs/other_model_vis_LAPS/mambaunet/pred"
    os.makedirs(save_dir, exist_ok=True)
    gts_dir = "/home/ubuntu/zj/KM-UNetV3/outputs/other_model_vis_LAPS/mambaunet/gts"
...
def main():
    ...
    # 模型实例化
    model = Mamba_UNet(predicted_frames=3,
                       input_frames=5,
    ...
    with open(r'/home/ubuntu/zj/KM-UNetV3/outputs/log/log_mambaunet.csv', 'w', newline='') as log_file:
        ...
        for epoch in range(epochs):
            ...
            if val_loss < best_val_loss:
                ...
                torch.save(model.state_dict(), r'/home/ubuntu/zj/KM-UNetV3/outputs/other_model_on_LAPS/model_Best_mambaunet.pth')
    ...
    print("=============================Test=================================")
    # 最终测试
    model_path = r'/home/ubuntu/zj/KM-UNetV3/outputs/other_model_on_LAPS/model_Best_mambaunet.pth'
