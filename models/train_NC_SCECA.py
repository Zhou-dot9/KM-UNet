...
from SCECA_Net import SCECANet
...
def test(model, test_loader,criterion):
    ...
    save_dir = "/home/ubuntu/zj/KM-UNetV3/outputs/other_model_vis_LAPS/SCECA/pred"
    os.makedirs(save_dir, exist_ok=True)
    gts_dir = "/home/ubuntu/zj/KM-UNetV3/outputs/other_model_vis_LAPS/SCECA/gts"
...
def main():
    ...
    # 模型实例化
    model = SCECANet(in_channels=5, out_channels=3).cuda()
    ...
    with open(r'/home/ubuntu/zj/KM-UNetV3/outputs/log/log_SCECA.csv', 'w', newline='') as log_file:
        ...
        for epoch in range(epochs):
            ...
            if val_loss < best_val_loss:
                ...
                torch.save(model.state_dict(), r'/home/ubuntu/zj/KM-UNetV3/outputs/other_model_on_LAPS/model_Best_SCECA.pth')
    ...
    print("=============================Test=================================")
    # 最终测试
    model_path = r'/home/ubuntu/zj/KM-UNetV3/outputs/other_model_on_LAPS/model_Best_SCECA.pth'
