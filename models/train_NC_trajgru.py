...
from TrajGru import encoder,forecaster,EF
...
def test(model, test_loader,criterion):
    ...
    save_dir = "/home/ubuntu/zj/KM-UNetV3/outputs/other_model_vis_LAPS/trajgru/pred"
    os.makedirs(save_dir, exist_ok=True)
    gts_dir = "/home/ubuntu/zj/KM-UNetV3/outputs/other_model_vis_LAPS/trajgru/gts"
...
def main():
    ...
    # 模型实例化
    model= EF(encoder, forecaster, 3).cuda()
    ...
    criterion = Weighted_mse_mae(thresholds=[0.1, 0.3, 0.5, 0.7, 0.8]).cuda()
    ...
    with open(r'/home/ubuntu/zj/KM-UNetV3/outputs/log/log_trajgru.csv', 'w', newline='') as log_file:
        ...
        for epoch in range(epochs):
            ...
            if val_loss < best_val_loss:
                ...
                torch.save(model.state_dict(), r'/home/ubuntu/zj/KM-UNetV3/outputs/other_model_on_LAPS/model_Best_trajgru.pth')
    ...
    print("=============================Test=================================")
    # 最终测试
    model_path = r'/home/ubuntu/zj/KM-UNetV3/outputs/other_model_on_LAPS/model_Best_trajgru.pth'
