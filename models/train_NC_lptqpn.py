...
def test(model, test_loader,criterion):
    ...
    save_dir = "/home/ubuntu/zj/KM-UNetV3/outputs/other_model_vis_LAPS/lptqpn/pred"
    os.makedirs(save_dir, exist_ok=True)
    gts_dir = "/home/ubuntu/zj/KM-UNetV3/outputs/other_model_vis_LAPS/lptqpn/gts"
...
def main():
    ...
    # 模型实例化
    model = LPTQPN(inp_channels=5, out_channels=3).cuda()
    ...
    scheduler = torch.optim.lr_scheduler.CosineAnnealingLR(optimizer, T_max=30, eta_min=1e-9)

    scaler = GradScaler()
    best_val_loss = 1234

    with open(r'/home/ubuntu/zj/KM-UNetV3/outputs/log/log_lptqpn.csv', 'w', newline='') as log_file:
        ...
        for epoch in range(epochs):
            ...
            if val_loss < best_val_loss:
                ...
                torch.save(model.state_dict(), r'/home/ubuntu/zj/KM-UNetV3/outputs/other_model_on_LAPS/model_Best_lptqpn.pth')
    ...
    print("=============================Test=================================")
    # 最终测试
    model_path = r'/home/ubuntu/zj/KM-UNetV3/outputs/other_model_on_LAPS/model_Best_lptqpn.pth'
