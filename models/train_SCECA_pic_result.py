...
def main():
    ...
    # 模型实例化
    model = SCECANet(in_channels=5, out_channels=20).cuda()
    ...
    with open(r'/home/ubuntu/zj/KM-UNetV3/outputs/log/log_SCECA.csv', 'w', newline='') as log_file:
        ...
        for epoch in range(epochs):
            ...
            if val_loss < best_val_loss:
                ...
                torch.save(model.state_dict(), r'/home/ubuntu/zj/KM-UNetV3/outputs/other_model_on_shanghai/model_Best_SCECA.pth')
    ...
    print("=============================Test=================================")
    # 最终测试 - 使用新的可视化方法
    model_path = r'/home/ubuntu/zj/KM-UNetV3/outputs/other_model_on_shanghai/model_Best_SCECA.pth'
    model.load_state_dict(torch.load(model_path))

    # 使用新的可视化保存路径
    vis_save_path = "/home/ubuntu/zj/KM-UNetV3/outputs/other_model_vis_shanghai/vis_SCECA-shanghai"
